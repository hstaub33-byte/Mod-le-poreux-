...
%--- Bloc 1 : Échelle du pore (3D hétérogène) ---
\begin{scope}[xshift=0cm]
    % Solide
    \fill[gray!30, rounded corners=3pt] (0,0) rectangle (2.8,3.5);
    % Pores (fluide)
    \fill[blue!15, rounded corners=2pt] (0.3,0.2) rectangle (1.1,1.5);
    \fill[blue!15, rounded corners=2pt] (1.4,0.4) rectangle (2.5,1.8);
    \fill[blue!15, rounded corners=2pt] (0.5,1.9) rectangle (2.3,3.2);
    % Interface
    \draw[red!70!black, thick, dashed, rounded corners=2pt] 
        (0.3,0.2) rectangle (1.1,1.5);
    \draw[red!70!black, thick, dashed, rounded corners=2pt] 
        (1.4,0.4) rectangle (2.5,1.8);
    \draw[red!70!black, thick, dashed, rounded corners=2pt] 
        (0.5,1.9) rectangle (2.3,3.2);
    % Légendes internes
    \node[font=\tiny, gray!60!black] at (1.4, 0.85) {$\Omega_s$};
    \node[font=\tiny, blue!60!black] at (0.7, 0.85) {$\Omega_l$};
    \node[font=\tiny, red!70!black] at (2.0, 3.0) {$A_{sf}$};
    % Titre
...
\begin{scope}[xshift=4.8cm]
    ...
    \node[font=\scriptsize, align=center] at (1.4, 1.4) 
        {$\langle C_i \rangle^l$, $\langle \phi_l \rangle^l$};
    \node[font=\scriptsize, align=center] at (1.4, 0.8) 
        {$\langle \Phi_s \rangle^s$};
    % Titre
...
\begin{scope}[xshift=9.6cm]
    ...
    % Axe z
    \draw[-{Stealth}, gray!60] (1.4,-0.3) -- (1.4,3.8);
    \node[right, font=\scriptsize] at (1.4, 3.8) {$z$};
    % Conditions limites
    \node[left, font=\tiny, align=right] at (0.9, 3.4) 
        {Paroi\\$\Phi_s = E$};
    \node[left, font=\tiny, align=right] at (0.9, 0.2) 
        {Bulk\\$\langle C_i\rangle^l = C_i^{\mathrm{bulk}}$};
    % Titre
...
L'interface $A_{sf}$ (en rouge) disparaît au profit de coefficients 
effectifs ($D^e_i$, $\sigma^e$, $a_v$).}
