...
représente l'échange à l'interface fluide/solide. On introduit la vitesse de réaction interfaciale
 $R_i$ définie par :
\begin{equation}
\mathbf{n}\cdot \mathbf{N}_i = R_i \quad \text{sur } A_{sf}
\end{equation}
Dans le cas d’une réaction électrochimique, $R_i$ est relié à la densité de courant interfacial $j$ par la loi de Faraday :
\begin{equation}
R_i = \frac{j}{n_e F}
\end{equation}
