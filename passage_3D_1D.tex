...
sans hypothèse sur la forme du profil de concentration.
...
représentatif contenant les deux phases. Les grandeurs locales sont 
...
l'équation de Poisson. On obtient ainsi :
...
On définit alors le tenseur de dispersion hydrodynamique :
...
maintenant sur les fluctuations du potentiel $\widetilde{\Phi}_s$
à l'échelle du pore.
...
$\avg{i_s} = -\sigma_s \avg{\nab\Phi_s}$ et en appliquant le théorème
...
les transferts de matière et de charge dans l'électrode poreuse. Les
