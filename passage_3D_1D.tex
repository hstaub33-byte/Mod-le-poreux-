...
L'homogénéisation de l'équation correspondante (Poisson)best présentée en annexe.
...
Dans la section suivante, on considère une réduction plus fortement simplifiée
de ce cadre, fondée sur le module de Thiele. Cette approche permettra
d'obtenir une solution analytique et d'analyser plus directement la
compétition entre diffusion et réaction dans l'électrode poreuse.
