...
\nomenclature[ADa]{$Da$}{Nombre de Damköhler $= j_n L / (F D_i C_\text{ref})$}
\nomenclature[ADi]{$D_i$}{Coefficient de diffusion de l'espèce $i$ ($\text{m}^2\text{s}^{-1}$)}
\nomenclature[ADei]{$D^e_i$}{Coefficient de diffusion effectif de l'espèce $i$ ($\text{m}^2\text{s}^{-1}$)}
\nomenclature[ADmig]{$D^{e,\text{mig}}_i$}{Coefficient de migration effectif de l'espèce $i$ ($\text{m}^2\text{s}^{-1}$)}
\nomenclature[ADdisp]{$D_\text{disp}$}{Coefficient de dispersion ($\text{m}^2\text{s}^{-1}$)}
\nomenclature[ADtot]{$D_\text{tot}$}{Coefficient de diffusion total, diffusion et dispersion ($\text{m}^2\text{s}^{-1}$)}
...
\nomenclature[An]{$\mathbf{n}$}{Vecteur normal unitaire (pointant du fluide vers le solide)}
...
\nomenclature[APe]{$Pe$}{Nombre de Péclet $= vL/D$}
...
\nomenclature[Bdelta]{$\bar{\delta}$}{Longueur de Debye adimensionnée $= \lambda_0/L$}
...
\nomenclature[Bphil]{$\phi_l$}{Potentiel électrique dans le fluide (V)}
\nomenclature[BPhis]{$\Phi_s$}{Potentiel électrique dans le solide (V)}
